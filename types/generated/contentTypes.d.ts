...
export interface ApiCocktailCocktail extends Schema.CollectionType {
...
export interface ApiMenuMenu extends Schema.CollectionType {
  ...
  attributes: {
    name: Attribute.String;
    price: Attribute.Decimal;
    starters: Attribute.JSON;
    seconds: Attribute.JSON;
    includes: Attribute.JSON;
    desserts: Attribute.JSON;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::cocktail.cocktail': ApiCocktailCocktail;
